...
class DatosSensorIncubadoraRepository(Repository_get,Repository_create,Repository_update,Repository_delete):  
     def __init__(self):
         self.__model = DatosSensorIncubadora
     ...
     def update(self, id, t: DatosSensorIncubadora) -> DatosSensorIncubadora:

...
class Datos_sensores_incubadora(db.Model):
    ...
    incubacion_id = db.Column('incubacion_id', db.Integer, db.ForeignKey('incubacion.id'), nullable=True)
    ...
    tipo_sensor_id = db.Column('tipo_sensor_id', db.Integer, db.ForeignKey('tipo_sensor.id'), nullable=True)

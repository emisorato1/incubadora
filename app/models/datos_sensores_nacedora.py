...
class Datos_sensores_nacedora(db.Model):
    ...
    nacimiento_id = db.Column('nacimiento_id', db.Integer, db.Foreignkey('incubacion.id'))
    ...
    tipo_sensor_id = db.Column('tipo_sensor_id', db.Integer, db.Foreignkey('tipo_sensor.id'))
